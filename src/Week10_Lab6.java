...
public class Week10_Lab6
{
	...
	public static void main(String[] args)
	{
		...
		RandomNumber rand = new RandomNumber(iLow, iHigh);
		JOptionPane.showMessageDialog(null, String.format("The lower boundary is %d, and the upper boundary is %d", rand.GetLowNumber(), rand.GetHighNumber()));
